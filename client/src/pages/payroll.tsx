          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-10">
                <p className="text-gray-500 mb-4">No payroll records found for the selected period</p>
              ...
              <div className="space-y-6">
                ...
                {/* Detailed Payslip View for the first record */}
                  ...
                  <div id={`payslip-${payrollData[0].id}`} className="border rounded-lg p-6 mt-8">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Pay Date: {formatDate(payrollData[0].payDate)}</p>
                        <p className="text-sm text-gray-600">Payment Status: 
                          <Badge className="ml-2 bg-green-100 text-green-800">
                            {payrollData[0].paymentStatus.charAt(0).toUpperCase() + payrollData[0].paymentStatus.slice(1)}
                          </Badge>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      <div className="col-span-2">
                        <h4 className="text-lg font-medium mb-4">Earnings & Deductions</h4>
                        <div className="space-y-3">
                          ...
                          {payrollData[0].details && payrollData[0].details.earnings && (
                            <>
                              {Object.entries(payrollData[0].details.earnings).map(([key, value]) => (
                          ...
                          {payrollData[0].details && payrollData[0].details.deductions && (
                            <>
                              {Object.entries(payrollData[0].details.deductions).map(([key, value]) => (
                                <div key={key} className="flex justify-between">
                                  <span className="text-gray-600">{key.replace(/([A-Z])/g, ' $1').trim()}</span>
                          ...
                          <div className="flex justify-between font-medium">
                            ...
                            <span className="text-red-600">-${payrollData[0].deductions.toLocaleString()}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="lg:border-l lg:pl-6">
                        <div className="bg-gray-50 p-6 rounded-lg">
                          ...
                          <div className="text-sm text-gray-500">
                            <p>Amount paid via bank transfer</p>
                    ...
                    <div className="mt-8 text-sm text-gray-500 text-center">
                      ...
                      <p>For any queries regarding this pay slip, please contact the HR department.</p>
                    </div>
                  </div>
                )}
              </div>
